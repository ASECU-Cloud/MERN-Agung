...
function Front() {
  window.onscroll = function () {
    if (window.location.href === "https://mern-agung.herokuapp.com") {
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-10 lg:w-1/2">
              ...
              <p className="font-medium text-base text-secondary max-w-xl lg:text-lg">
                Saya Mochamad Agung Sudrajat berusia 20 tahun, yang berasal dari
                kota pahlawan yakni Surabaya. Memiliki keahlian dalam bidang
                Coding, Web Development, Game Development, 3D Design, dan
                lainnnya.
              </p>
            </div>
            <div className="w-full px-4 lg:w-1/2">
              ...
              <p className="font-medium text-base text-secondary mb-6 lg:text-lg">
                Bagi Anda yang berkenan menjalin persaudaraan dan tali
                silaturahmi bersama saya, Anda bisa follow akun sosial media
                dibawah ini untuk mengetahui lebih detail.
              </p>
          ...
          <div className="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
            <div className="mb-12 p-4 md:w-1/2">
              <div className="rounded-md shadow-md overflow-hidden">
                <a href="https://mern-tokoku.herokuapp.com/">
              ...
              <p className="font-medium text-base text-secondary">
                merupakan sebuah Project sederhana dibuat menggunakan ReactJS,
                dan stack yang lain seperti Express, Node, dan MongoDB. Sistem
                didalamnya menggunakan React Redux untuk menghandle state yang
                ada.
              </p>
            </div>
          </div>
